...
class PhoneBookAllTests(unittest.TestCase):
    ...
    #         phoneBook = PhoneBook(location=self.location,
    #                               db_provider=self.provider)
    #         got = phoneBook.createContact(test['args'])
    #         self.assertEqual(got, test["expected"],
    #                          f"Check test case({test['name']}) of create contact test")
    ...
    def test_0_setup_system(self):
        ...
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} connect test")

    def test_1_create_contact_pass(self):
        self.getDatabaseService()
        phoneBook = PhoneBook(location=self.location,
                              db_provider=self.provider)
        data = {
        ...
        expected = (True, 'Contact created successfully')
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} create test")
    ...
    def test_5_fail_create_contact(self):
        ...
        expected = (False, "Failed to create contact Error")
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} create fail test")
    ...
    def test_3_edit_contact(self):
        ...
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} editContact test")
    ...
    def test_4_delete_contact(self):
        ...
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} deleteContact test")

    def test_6_fail_list_contacts(self):
        self.getDatabaseService()
        phoneBook = PhoneBook(location=None, db_provider=self.provider)
        returned = phoneBook.listContacts()
        self.assertIn(False, returned,
                      f"Check {self.db_name} list all fail test")
    ...
    def test_7_fail_edit_contact(self):
        ...
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} editContact fail test")
    ...
    def test_8_fail_delete_contact(self):
        ...
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} deleteContact fail test")
    ...
    def test_9_close_phonebook(self):
        ...
        self.assertEqual(returned, expected,
                         f"Check {self.db_name} disconnect test")
...
if __name__ == '__main__':
    ...
    if (PhoneBookAllTests.db_name == 'firestore'):
        ...
        cred = credentials.Certificate(
            path2 + "\providers\interfaces-prac-firebase.json")
